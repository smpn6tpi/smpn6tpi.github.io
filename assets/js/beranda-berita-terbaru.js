...
function showLabelPosts(json) {
    var ul = document.getElementById('berita-terbaru-beranda'); // ID UL yang akan diisi
...
<h2>Berita</h2>
    ...
    <ul id="berita-terbaru-beranda" class="post-list">
        </ul>
    
    <script type="text/javascript" 
        src="/feeds/posts/default/-/Berita?alt=json-in-script&amp;max-results=5&amp;callback=showLabelPosts">
    </script>
    
    <p style="text-align: center; margin-top: 20px;">
        <a href="/search/label/Berita" class="cta-button">Lihat Semua Berita »</a>
    </p>
</section>
*/