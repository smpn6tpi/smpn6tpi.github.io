        ...
        function toggleView(targetId) {
            ...
            if (isPinValid) {
                if (targetId === 'rekap-absen') { 
                 ...
                 const loadingStatusEl = document.getElementById(`loading-status-rekap-absen`) || document.getElementById('status-verif');
                 if(loadingStatusEl) {
                      updateStatus(loadingStatusEl.id, "PIN tidak valid. Silakan verifikasi PIN untuk memuat data.", 'error');
                 }
            }
